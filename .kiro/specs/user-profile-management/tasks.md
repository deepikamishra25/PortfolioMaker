...
- [ ] 2. Extend the User Mongoose model with profile fields
  ...
  - [ ] 2.1 Write property test for registration defaults (Property 1)
  ...
  - [ ] 2.2 Write property test for bio length validation (Property 2)
...
- [ ] 3. Create Multer upload middleware
  ...
  - [ ] 3.1 Write property test for avatar upload validation (Property 9)
...
- [ ] 4. Create profile validation middleware
  ...
  - [ ] 4.1 Write property test for invalid email rejection (Property 5)
  ...
  - [ ] 4.2 Write property test for social link URL validation (Property 8)
...
- [ ] 5. Create the user controller
  ...
  **`uploadAvatar(req, res, next)`**
  ...
  - [ ] 5.1 Write property test for profile response shape and password exclusion (Property 3)
  ...
  - [ ] 5.2 Write property test for profile update reflecting submitted values (Property 4)
  ...
  - [ ] 5.3 Write property test for partial update preserving omitted fields (Property 7)
  ...
  - [ ] 5.4 Write property test for duplicate username/email conflict (Property 6)
...
- [ ] 6. Create user routes and register them on the server
...
- [ ] 7. Checkpoint — verify backend endpoints
...
- [ ] 8. Create the profile API service on the client
...
- [ ] 9. Expose `setUser` from AuthContext
...
- [ ] 10. Build the ProfileForm component
  ...
  **Layout and styling (Requirements 5.7, 5.8)**
  ...
  - [ ] 10.1 Write property test for image URL construction (Property 11)
  ...
  - [ ] 10.2 Write property test for error toast message completeness (Property 12)
...
- [ ] 11. Wire ProfileForm into the Dashboard
...
- [ ] 12. Checkpoint — verify avatar upload round-trip (Property 10)
  ...
  - [ ] 12.1 Write property test for avatar upload round-trip (Property 10)
